...
mod tests {
    ...
    fn message_id_keeps_fieldless_enum_compatibility() {
        ...
        assert_eq!(MessageId::AgentControlQueueFullBody as usize, 752);
        assert_eq!(MessageId::SlashInvalidArgumentsTitle as usize, 753);
        assert_eq!(MessageId::SlashQuotedArgumentsUnsupported as usize, 754);
        assert_eq!(
