...
> See [user manual](../../docs/user-guide/en/token-saving/tokenless.md) for per-strategy trigger conditions.
...
token counts. See the [user manual](../../docs/user-guide/en/token-saving/tokenless.md#statistics--measurement)
