...
Approved design for the next AgentSight implementation phase. The APIs, schema, and user
interface described here are not implemented yet.
...
- Sensitive source path.
- All-untrusted-destinations policy scope.
