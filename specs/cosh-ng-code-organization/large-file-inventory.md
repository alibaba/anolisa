...
| 829 | `src/agent/approval_bridge.rs` | agent | Approval bridge; pre-existing (main baseline 805, registered on main at 737). The #1940 lifecycle-ledger growth and the #2064 high-risk action-set gate co-locate with their request-mapping host. Split request mapping from replay. |
